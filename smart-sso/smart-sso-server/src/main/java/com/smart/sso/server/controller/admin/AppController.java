...
public class AppController extends BaseController {
	...
	public @ResponseBody Result list(@ValidateParam(name = "名称 ") String name,
		...
		return Result.create().setData(appService.findPaginationByName(name, new Pagination<App>(pageNo, pageSize)));
	}
	...
	public @ResponseBody Result delete(@ValidateParam(name = "ids", validators = { Validator.NOT_BLANK }) String ids) {
		return Result.create().setData(appService.deleteById(getAjaxIds(ids)));
	}
	...
	public @ResponseBody Result syncPermissions(
		...
		return Result.create(ResultCode.SUCCESS, "权限同步成功");
	}
}